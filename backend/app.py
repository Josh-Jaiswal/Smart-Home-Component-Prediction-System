...
from backend.smart_home_predictor import SmartHomePredictor
from flask_cors import CORS

static_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'static')
if not os.path.exists(static_dir):
    os.makedirs(static_dir)
# Updated static_folder path for Vite build
app = Flask(__name__, 
...
predictor = SmartHomePredictor(data_path=os.path.join(os.path.dirname(__file__), "synthetic_smart_home_components.csv"))
...
def submit():
    try:
        ...
        config_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'static', 'temp_config.json')
